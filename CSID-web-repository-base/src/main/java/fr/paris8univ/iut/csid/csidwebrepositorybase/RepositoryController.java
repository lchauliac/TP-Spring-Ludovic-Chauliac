...
public class RepositoryController {
	...
	@PostMapping("/{nameRepo}/issue")
	public ResponseEntity<IssueResponse> postIssues(@PathVariable String nameRepo ,@RequestBody IssueRequest issue) throws URISyntaxException {
		IssueResponse issueR = repositoryService.createIssues(nameRepo,issue);
		System.out.println(nameRepo);
		return ResponseEntity.created(new URI(issueR.getHtmlUrl())).body(issueR);
	}
